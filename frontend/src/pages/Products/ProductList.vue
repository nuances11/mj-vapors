                ...
                <tr v-for="(option, index) in form.attribute_options" :key="`attr-${index}`">
                  <td>
                    <q-select
                      class="q-ma-xs"
                      dense
                      v-model="form.attribute_options[index].attribute_id"
                  ...
                  <td>
                    <q-select
                      class="q-ma-xs"
                      dense
                      v-model="form.attribute_options[index].attribute_option_id"
...
const checkAttributeEntry = async () => {
  if (form.value.attribute_options.length > 0) {
    const uniqueValues = new Set(form.value.attribute_options.map(v => v.attribute_id));
